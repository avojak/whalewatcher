...
/**
 * This is a modified version of Granite.SettingsSidebarRow to allow access to
 * the private class.
 */
private class WhaleWatcher.Widgets.ContainersSidebarRow : Gtk.ListBoxRow {

    public Granite.SettingsPage.StatusType status_type {
        set {
            switch (value) {
                case Granite.SettingsPage.StatusType.ERROR:
                    status_icon.icon_name = "user-busy";
                    break;
                case Granite.SettingsPage.StatusType.OFFLINE:
                    status_icon.icon_name = "user-offline";
                    break;
                case Granite.SettingsPage.StatusType.SUCCESS:
                    status_icon.icon_name = "user-available";
                    break;
                case Granite.SettingsPage.StatusType.WARNING:
    ...
    public unowned Granite.SettingsPage page { get; construct; }
    ...
    public ContainersSidebarRow (Granite.SettingsPage page) {
        Object (
            page: page
        );
    }
    ...
    construct {
        ...
        if (page.status_type != Granite.SettingsPage.StatusType.NONE) {
