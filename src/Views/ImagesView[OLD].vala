...
//      private Gee.List<string> selected_images = new Gee.ArrayList<string> ();
...
//          browse_images_view.image_selection_changed.connect ((images) => {
//              on_image_selection_changed (images);
//          });
...
//          });
//          browse_images_view.export_button_clicked.connect (() => {
...
//      private void on_image_selection_changed (Gee.List<string> images) {
//          selected_images.clear ();
//          selected_images.add_all (images);
//      }
...
//      public Gee.List<string> get_selected_images () {
